...
public class PasswordTakerForEncryption extends javax.swing.JFrame
{
    ...
    boolean verifyPasswords()
    {
        ...
        {
            eightCharInstructionLabel.setText("For security reasons you must enter password of atleast 5 characters");
    ...
    private void initComponents() {
        ...
        suggestionLabel.setText("Select a long password for better security ");
